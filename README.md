...
- **Class features & resources (5e)** — the Core tab shows a live **Class Features** panel: limited-use resources (**Rage, Ki, Channel Divinity, Bardic Inspiration, Sorcery Points, Lay on Hands, Second Wind, Action Surge…**) with pip trackers and **Short/Long rest** reset buttons. Martial features are wired into rolls: **Barbarian Rage** is a toggle that spends a use and adds its bonus damage to your melee attacks (ranged excluded); **Rogue Sneak Attack** appears as a scaling click-to-roll; **Extra Attack** shows your attacks-per-action.
