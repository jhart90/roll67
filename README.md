...
- **Class features & resources (5e)** — the Core tab shows a live **Class Features** panel: limited-use resources (**Rage, Ki, Channel Divinity, Bardic Inspiration, Sorcery Points, Lay on Hands, Second Wind, Action Surge, Battle Master superiority dice…**) with pip trackers and **Short/Long rest** reset buttons. Features are wired into the actual rolls:
  ...
  - **Subclasses** — Battle Master superiority dice + die roll; Champion Improved Critical (crit range 19–20/18–20, enforced in combat) + Remarkable Athlete; **Eldritch Knight / Arcane Trickster** third-caster spell slots (INT); **Paladin Divine Smite** roll (+ Improved Divine Smite); **Warlock Mystic Arcanum** (6th–9th) trackers; **Barbarian Zealot** Divine Fury. Level-up records the **real named feature** for ~30 of the most-played subclasses (Champion, Battle Master, Life/War/Light domains, Circle of the Moon, Assassin, Gloom Stalker, Hexblade, Evocation, and more).
- **Character builder (SWN)** — a **⬆ Level Up** button walks a Stars Without Number character through each level (up to 10): choose Warrior / Expert / Psychic / Adventurer, set hit points (max at level 1, then average or a chat-rolled d6 — Warriors get their +2), apply the class's attack-bonus progression, and pick a **background** that grants its free skill. The Core tab shows a **Class & Foci** panel: the class ability, current attack bonus, a psychic **Effort** tracker, and your foci — with **+ Focus** (22 foci that grant skills, boost HP, or upgrade at level 2), **+ Background**, and **+ Equipment package** pickers (six A–F kits that drop weapons, armor, gear and credits straight onto the sheet). Every addition applies its effects automatically and announces itself in chat.
