/**
 * The app's one swatch palette, ordered as a color wheel with the neutrals
 ...
 * its slots on brown, tan and olive — colors that read as three shades of mud
 ...
 * in the panel instead of a color.
 *
 * Shared by the pinned-pill picker and the player-color picker so the two
 * cannot drift into two different ideas of "the colors".
 */
 ...
 *  as a color scheme. Picking one by hand is of course still allowed. */
