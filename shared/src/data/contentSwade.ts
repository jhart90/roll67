...
const POWERS: P[] = [
  ...
  ['Entangle', 2, 'Novice', 'Everyone in a Medium Blast Template is Entangled (Bound with a raise)', { rangeFt: 72, save: 'agility', onSave: 'negate', condition: 'entangled', aoe: { shape: 'sphere', sizeHexes: 3 } }],
  ['Environmental Protection', 2, 'Novice', 'Breathe/operate in a hostile environment'],
  ['Fear', 2, 'Novice', 'Everyone in a Medium Blast Template makes a Spirit roll or panics', { rangeFt: 72, save: 'spirit', onSave: 'negate', condition: 'frightened', aoe: { shape: 'sphere', sizeHexes: 3 } }],
  ...
  ['Light/Darkness', 1, 'Novice', 'Fills a Medium Blast Template with light or with darkness. Cast as Darkness the area blinds those inside it; cast as Light it simply illuminates, and needs no roll.', { rangeFt: 72, condition: 'blinded', aoe: { shape: 'sphere', sizeHexes: 3 } }],
  ...
  ['Stun', 2, 'Novice', 'Everyone in a Medium Blast Template makes a Vigor roll or is Stunned', { rangeFt: 72, save: 'vigor', onSave: 'negate', condition: 'stunned', aoe: { shape: 'sphere', sizeHexes: 3 } }],
  ...
  ['Slumber', 2, 'Seasoned', 'Everyone in a Medium Blast Template falls asleep unless they resist', { rangeFt: 72, save: 'spirit', onSave: 'negate', condition: 'unconscious', aoe: { shape: 'sphere', sizeHexes: 3 } }],
