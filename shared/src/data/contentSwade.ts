...
const POWERS: P[] = [
  ...
  ['Entangle', 2, 'Novice', 'Everyone in a Medium Blast Template is Entangled (Bound with a raise)', { rangeFt: 72, save: 'agility', onSave: 'negate', condition: 'entangled' }],
  ['Environmental Protection', 2, 'Novice', 'Breathe/operate in a hostile environment'],
  ['Fear', 2, 'Novice', 'Everyone in a Medium Blast Template makes a Spirit roll or panics', { rangeFt: 72, save: 'spirit', onSave: 'negate', condition: 'frightened' }],
  ...
  ['Light/Darkness', 2, 'Novice', 'Fills a Medium Blast Template with light or with darkness. Cast as Darkness the area blinds those inside it; cast as Light it simply illuminates, and needs no roll.', { rangeFt: 72, condition: 'blinded', aoe: { shape: 'sphere', sizeHexes: 3 } }],
  ...
  ['Speed', 2, 'Seasoned', 'Double a target’s Pace'],
  ['Stun', 2, 'Novice', 'Everyone in a Medium Blast Template makes a Vigor roll or is Stunned', { rangeFt: 72, save: 'vigor', onSave: 'negate', condition: 'stunned' }],
  ...
  // --- additional powers ---
  ['Banish', 3, 'Veteran', 'Send an extraplanar creature back where it came from', { rangeFt: 72, save: 'spirit', onSave: 'negate' }],
  ['Barrier', 2, 'Seasoned', 'Raise a wall of force, ice, or flame'],
  ...
  ['Damage Field', 4, 'Seasoned', 'Anyone touching you takes damage', { damage: '2d4!', rangeFt: 5 }],
  ['Darksight', 1, 'Novice', 'See clearly in darkness'],
  ['Detect Life', 2, 'Novice', 'Sense living creatures nearby'],
  ['Disguise', 2, 'Seasoned', 'Change a target’s appearance'],
  ['Divination', 5, 'Heroic', 'Ask a higher power one pointed question'],
  ...
  ['Growth/Shrink', 2, 'Seasoned', 'Change a target’s Size, Strength, and Toughness'],
  ...
  ['Intangibility', 5, 'Heroic', 'Become insubstantial and pass through matter'],
  ['Mind Link', 1, 'Novice', 'Silent communication with willing allies'],
  ['Mind Reading', 2, 'Novice', 'Pull one honest answer from a subject’s thoughts', { rangeFt: 72, save: 'smarts', onSave: 'negate' }],
  ['Mind Wipe', 3, 'Veteran', 'Erase or alter a subject’s recent memories', { rangeFt: 72, save: 'smarts', onSave: 'negate' }],
  ['Object Reading', 2, 'Seasoned', 'See the past events attached to an object'],
  ['Sanctuary', 2, 'Novice', 'Evil creatures must resist or cannot approach', { rangeFt: 5, save: 'spirit', onSave: 'negate' }],
  ['Shape Change', 3, 'Novice', 'Take the form of a beast you know'],
  ['Silence', 2, 'Novice', 'Muffles all sound in a Medium Blast Template — no speech, no shouted warnings, no spoken incantations', { rangeFt: 72, condition: 'silenced', aoe: { shape: 'sphere', sizeHexes: 3 } }],
  ['Slow', 2, 'Seasoned', 'Halve a target’s Pace and actions', { rangeFt: 72, save: 'agility', onSave: 'negate', condition: 'distracted' }],
  ['Slumber', 2, 'Seasoned', 'Everyone in a Medium Blast Template falls asleep unless they resist', { rangeFt: 72, save: 'spirit', onSave: 'negate', condition: 'unconscious' }],
  ...
  ['Summon Ally', 2, 'Novice', 'Call a servitor creature to fight for you'],
  ['Wall Walker', 2, 'Novice', 'Walk on walls and ceilings at full Pace'],
  ['Warrior’s Gift', 4, 'Seasoned', 'Grant a target a combat Edge for the scene'],
  ['Zombie', 3, 'Veteran', 'Raise a corpse as an obedient servant'],
  ['Resurrection', 30, 'Heroic', 'Bring the dead back to life — the body must be reasonably intact and dead no more than a year; the caster rolls at −8 and the subject returns Exhausted (merely Exhausted on a raise). +5 Power Points raises someone dead up to a decade', { rangeFt: 5 }],
  ['Sloth/Speed', 2, 'Seasoned', 'Halve a target’s movement (Sloth) or double it (Speed) — see the Slow and Speed entries, which are its two halves', { rangeFt: 72, save: 'spirit', onSave: 'negate' }],
];
