...
import { durationLabel } from '../systems/swadeDuration.js';
...
const WEAPONS: W[] = [
  ...
  ['Great Sword', 'Melee', '1d10!', 'slashing', 'str', ['two-handed', 'min Str d10'], 400, 6],
  ['Maul', 'Melee', '1d10!', 'bludgeoning', 'str', ['two-handed', '+2 damage to break objects', 'min Str d10'], 400, 10],
  ['Katana', 'Melee', '1d6!+1', 'slashing', 'str', ['two-handed', 'min Str d6'], 1000, 3],
  ['Sling', 'Ranged', '1d4!', 'bludgeoning', 'ranged', ['range 20/40/80', 'add Str die to damage', 'thrown with Athletics', 'min Str d4', 'caliber: stones'], 10, 1],
  ['Bow', 'Ranged', '2d6!', 'piercing', 'ranged', ['range 60/120/240', 'min Str d6', 'caliber: arrows'], 250, 3],
  ['Crossbow', 'Ranged', '2d6!', 'piercing', 'ranged', ['range 50/100/200', 'AP 2', 'hand-drawn', '1 action to reload', 'min Str d6', 'caliber: bolts'], 250, 5],
  ['Throwing Knife', 'Ranged', '1d4!', 'piercing', 'ranged', ['range 18/36/72', 'add Str die to damage']],
  ['Derringer', 'Ranged', '2d4!', 'kinetic', 'ranged', ['range 15/30/60', 'mag 2', '−2 to be Noticed if hidden', 'min Str d4', 'caliber: bullets-small'], 100, 1],
  ...
  ['Hunting Rifle', 'Ranged', '2d8!', 'kinetic', 'ranged', ['range 120/240/480', 'mag 5', 'AP 2', 'snapfire', 'min Str d6', 'caliber: bullets-medium'], 350, 8],
  ...
  ['Flintlock Pistol', 'Ranged', '2d6!+1', 'kinetic', 'ranged', ['range 25/50/100', 'Reload 3', 'min Str d4', 'caliber: shot'], 150, 3],
  ...
  ['Chainsaw', 'Melee', '2d6!+4', 'slashing', 'str', ['critical failure hits the user', 'min Str d6'], 200, 20],
  ...
  ['Molecular Sword', 'Melee', '1d8!+2', 'slashing', 'str', ['AP 4', 'min Str d6'], 500, 2],
  // --- more ranged ---
  ['Blowgun', 'Ranged', '1', 'piercing', 'ranged', ['range 18/36/72', 'delivers poison']],
  ['Longbow', 'Ranged', '2d6!', 'piercing', 'ranged', ['range 75/150/300', 'AP 1', 'min Str d8', 'caliber: arrows'], 300, 3],
  ['Heavy Crossbow', 'Ranged', '2d8!', 'piercing', 'ranged', ['range 75/150/300', 'AP 2', 'needs a windlass — Reload 2', 'min Str d6', 'caliber: bolts'], 400, 8],
  ['Musket', 'Ranged', '2d8!', 'kinetic', 'ranged', ['range 50/100/200', 'Brown Bess and similar', 'Reload 3', 'min Str d6', 'caliber: shot'], 300, 15],
  ['Blunderbuss', 'Ranged', '3d6!', 'kinetic', 'ranged', ['range 50/100/200', 'damage 3d6/2d6/1d6 by range band', 'treat as a shotgun', 'Reload 3', 'min Str d6', 'caliber: shot'], 300, 12],
  ...
  ['Crossbow (Modern)', 'Ranged', '2d6!', 'piercing', 'ranged', ['range 75/150/300', 'AP 2', 'min Str d6', 'caliber: bolts'], 300, 7],
  // ---- Black powder (Reload 3 unless noted) ----
  ['Kentucky Rifle', 'Ranged', '2d8!', 'kinetic', 'ranged', ['range 75/150/300', 'AP 2', 'the tight rifling makes it Reload 4', 'min Str d6', 'caliber: shot'], 300, 8],
  ['Springfield Model 1861', 'Ranged', '2d8!', 'kinetic', 'ranged', ['range 75/150/300', 'Reload 3', 'min Str d6', 'caliber: shot'], 250, 11],
  // ---- Pistols: revolvers ----
  ...
  // Isaiah's sidearm: a nine-shot percussion revolver built around a second,
  // larger barrel loaded with buckshot. Carried as two weapons on the sheet
  // because the barrels roll nothing alike.
  ['Confederate LeMat Cavalry Pistol', 'Ranged', '2d6!+1', 'kinetic', 'ranged', ['range 60/120/240', 'mag 9', 'one action per chamber to reload — Speed Load does not apply', 'black powder: conspicuous, smoky and loud', 'min Str d6', 'era: old west — nine-shooter', 'caliber: bullets-medium'], 300, 4],
  ['Confederate LeMat Cavalry Pistol (Under-barrel Shotgun)', 'Ranged', '3d6!', 'kinetic', 'ranged', ['range 25/50/100', 'mag 1', 'damage 3d6/2d6/1d6 by range band', 'one action to reload — Speed Load does not apply', 'black powder: conspicuous, smoky and loud', 'min Str d6', 'the same gun as the LeMat Cavalry Pistol — its cost and weight are on that row', 'era: old west — grapeshot barrel', 'caliber: shot'], 0, 0],
  ...
  ['Desert Eagle (.50)', 'Ranged', '2d8!', 'kinetic', 'ranged', ['range 75/150/300', 'AP 2', 'mag 7', 'min Str d6', 'caliber: bullets-large'], 300, 8],
  ...
  // ---- Shotguns ----
  ['Sawed-Off Double-Barrel', 'Ranged', '3d6!', 'kinetic', 'ranged', ['range 25/50/100', 'mag 2', 'min Str d4', 'caliber: shells'], 150, 6],
  ['Streetsweeper', 'Ranged', '3d6!', 'kinetic', 'ranged', ['range 60/120/240', 'mag 12', 'min Str d6', 'caliber: shells'], 450, 10],
  // ---- Rifles: lever- and bolt-action ----
  ['Barrett (.50)', 'Ranged', '2d10!', 'kinetic', 'ranged', ['range 250/500/1000', 'AP 4', 'mag 10', 'Heavy Weapon', 'snapfire', 'the 10-shot magazine weighs 2 lbs; almost always scoped', 'min Str d8', 'caliber: bullets-large'], 750, 35],
  ['M1 Garand (.30-06)', 'Ranged', '2d8!', 'kinetic', 'ranged', ['range 120/240/480', 'AP 2', 'mag 8', 'the standard US infantry rifle of the Second World War', 'min Str d6', 'caliber: bullets-medium'], 300, 10],
  ['Hunting Rifle (.308)', 'Ranged', '2d8!', 'kinetic', 'ranged', ['range 120/240/480', 'AP 2', 'mag 5', 'snapfire', 'min Str d6', 'caliber: bullets-medium'], 350, 8],
  ['Sharps Big 50 (.50)', 'Ranged', '2d10!', 'kinetic', 'ranged', ['range 150/300/600', 'AP 2', 'mag 1', 'snapfire', 'min Str d8', 'caliber: bullets-large'], 400, 11],
  ['Spencer Carbine (.52)', 'Ranged', '2d8!', 'kinetic', 'ranged', ['range 100/200/400', 'AP 2', 'mag 7', 'min Str d6', 'caliber: bullets-medium'], 250, 8],
  ["Winchester '73 (.44-40)", 'Ranged', '2d8!-1', 'kinetic', 'ranged', ['range 120/240/480', 'AP 2', 'mag 15', 'min Str d6', 'caliber: bullets-medium'], 300, 10],
  // ---- Assault rifles ----
  ['AK47 (7.62mm)', 'Ranged', '2d8!+1', 'kinetic', 'ranged', ['range 120/240/480', 'AP 2', 'RoF 3', 'mag 30', 'min Str d6', 'caliber: bullets-medium'], 450, 10],
  ['M-16 (5.56mm)', 'Ranged', '2d8!', 'kinetic', 'ranged', ['range 120/240/480', 'AP 2', 'RoF 3', 'mag 30', 'the A-2 can fire a three-round burst', 'min Str d6', 'caliber: bullets-medium'], 400, 8],
  ['Steyr AUG (5.56mm)', 'Ranged', '2d8!', 'kinetic', 'ranged', ['range 120/240/480', 'AP 2', 'RoF 3', 'mag 30', 'may fire a three-round burst', 'min Str d6', 'caliber: bullets-medium'], 400, 8],
  // ---- Machine guns (Reload 2; minimum RoF 2 unless noted) ----
  ['Browning Automatic Rifle (BAR)', 'Ranged', '2d8!', 'kinetic', 'ranged', ['range 100/200/300', 'AP 2', 'RoF 3', 'mag 20', 'RoF 1 to 3; magazine-fed, one action to reload', 'min Str d8', 'caliber: bullets-medium'], 300, 17],
  ['Gatling (.45)', 'Ranged', '2d8!', 'kinetic', 'ranged', ['range 120/240/480', 'AP 2', 'RoF 3', 'mag 100', 'weapon mount — no minimum Strength, no Recoil', 'caliber: bullets-medium'], 500, 170],
  ['Minigun (7.62mm)', 'Ranged', '2d8!+1', 'kinetic', 'ranged', ['range 150/300/600', 'AP 2', 'RoF 5', 'mag 4000', 'minimum RoF 3', 'needs a backpack harness; the ammo adds 85 lbs full', 'min Str d10', 'caliber: bullets-medium'], 100000, 85],
  ['M2 Browning (.50 Cal)', 'Ranged', '2d10!', 'kinetic', 'ranged', ['range 250/500/1000', 'AP 4', 'RoF 3', 'mag 200', 'Heavy Weapon', 'weapon mount — no minimum Strength, no Recoil', 'caliber: bullets-large'], 1500, 84],
  ['M60 (7.62mm)', 'Ranged', '2d8!+1', 'kinetic', 'ranged', ['range 150/300/600', 'AP 2', 'RoF 3', 'mag 100', 'min Str d8', 'caliber: bullets-medium'], 6000, 33],
  ['MG42 (7.92mm)', 'Ranged', '2d8!+1', 'kinetic', 'ranged', ['range 150/300/600', 'AP 2', 'RoF 4', 'mag 200', 'min Str d10', 'caliber: bullets-medium'], 750, 26],
  ['SAW (5.56mm)', 'Ranged', '2d8!', 'kinetic', 'ranged', ['range 150/300/600', 'AP 2', 'RoF 4', 'mag 200', 'min Str d8', 'caliber: bullets-medium'], 4000, 20],
...
interface PowerMech {
  ...
  condition?: string;
  /** The book's DUR column verbatim. Every power carries one. */
  duration?: string;
}
type P = [string, number, string, string, PowerMech?];
const POWERS: P[] = [
  ['Arcane Protection', 1, 'Novice', 'Foes suffer a penalty to affect you with powers', { duration: '5' }],
  ['Armor', 1, 'Novice', '+2 Armor for 5 rounds — toggle "Armor" on the sheet while maintained', { duration: '5' }],
  // Medium Blast Template ≈ 24 ft across; no dodging it by the book.
  ['Blast', 3, 'Seasoned', 'Medium blast template of damage', { damage: '2d6!', rangeFt: 144, aoe: { shape: 'sphere', sizeHexes: 3 }, duration: 'Instant' }],
  // Direct missile: arcane skill vs TN 4 to hit (raise = +1d6!).
  ['Bolt', 1, 'Novice', 'A missile of arcane energy', { damage: '2d6!', rangeFt: 144, duration: 'Instant' }],
  ...
  ['Dispel', 1, 'Seasoned', 'Cancel an enemy power', { duration: 'Instant' }],
  ['Empathy', 1, 'Novice', 'Read emotions; bonus to social rolls', { duration: '5' }],
  ['Entangle', 2, 'Novice', 'Everyone in a Medium Blast Template is Entangled (Bound with a raise)', { rangeFt: 72, save: 'agility', onSave: 'negate', condition: 'entangled', duration: 'Instant' }],
  ['Environmental Protection', 2, 'Novice', 'Breathe/operate in a hostile environment', { duration: '1H' }],
  ['Fear', 2, 'Novice', 'Everyone in a Medium Blast Template makes a Spirit roll or panics', { rangeFt: 72, save: 'spirit', onSave: 'negate', condition: 'frightened', duration: 'Instant' }],
  ['Fly', 3, 'Veteran', 'Fly at Pace 12', { duration: '5' }],
  ...
  ['Healing', 3, 'Novice', 'Heal a Wound (two with a raise) within the golden hour', { damage: '5', heal: true, rangeFt: 5, duration: 'Instant' }],
  ['Illusion', 3, 'Novice', 'Create a visual illusion', { duration: '5' }],
  ['Invisibility', 5, 'Seasoned', 'Turn a willing target invisible (harder to hit or notice)', { heal: true, rangeFt: 5, condition: 'invisible', duration: '5' }],
  ['Light/Darkness', 2, 'Novice', 'Fills a Medium Blast Template with light or with darkness. Cast as Darkness the area blinds those inside it; cast as Light it simply illuminates, and needs no roll.', { rangeFt: 72, condition: 'blinded', aoe: { shape: 'sphere', sizeHexes: 3 }, duration: '10m' }],
  ['Protection', 1, 'Novice', '+2 Toughness — toggle "Protection" on the sheet while maintained', { duration: '5' }],
  ['Puppet', 3, 'Veteran', 'Control a target’s actions (opposed by Spirit)', { duration: '5' }],
  ['Relief', 1, 'Novice', 'Remove Fatigue or Shaken', { duration: 'Instant' }],
  ['Smite', 2, 'Novice', 'A weapon gains +2 damage — toggle "Smite" + mark the weapon wielded', { duration: '5' }],
  ['Speed', 2, 'Seasoned', 'Double a target’s Pace', { duration: '5' }],
  ['Stun', 2, 'Novice', 'Everyone in a Medium Blast Template makes a Vigor roll or is Stunned', { rangeFt: 72, save: 'vigor', onSave: 'negate', condition: 'stunned', duration: 'Instant' }],
  ['Telekinesis', 5, 'Seasoned', 'Move objects or creatures with your mind', { duration: '5' }],
  ['Teleport', 2, 'Seasoned', 'Instantly move up to 12″ (double with a raise)', { duration: 'Instant' }],
  // --- additional powers ---
  ['Banish', 3, 'Veteran', 'Send an extraplanar creature back where it came from', { rangeFt: 72, save: 'spirit', onSave: 'negate', duration: 'Instant' }],
  ['Barrier', 2, 'Seasoned', 'Raise a wall of force, ice, or flame', { duration: '5' }],
  ['Beast Friend', 2, 'Novice', 'Command animals within earshot', { duration: '10m' }],
  ['Blind', 2, 'Novice', 'Target rolls Agility or is Blinded', { rangeFt: 72, save: 'agility', onSave: 'negate', condition: 'blinded', duration: 'Instant' }],
  ['Bolt (Greater)', 4, 'Veteran', 'A heavier missile of arcane force', { damage: '3d6!', rangeFt: 144, duration: 'Instant' }],
  ['Damage Field', 4, 'Seasoned', 'Anyone touching you takes damage', { damage: '2d4!', rangeFt: 5, duration: '5' }],
  ['Darksight', 1, 'Novice', 'See clearly in darkness', { duration: '1H' }],
  ['Detect Life', 2, 'Novice', 'Sense living creatures nearby', { duration: '5' }],
  ['Disguise', 2, 'Seasoned', 'Change a target’s appearance', { duration: '10m' }],
  ['Divination', 5, 'Heroic', 'Ask a higher power one pointed question', { duration: 'Instant' }],
  ['Drain Power Points', 2, 'Veteran', 'Steal Power Points from a rival caster', { rangeFt: 72, save: 'spirit', onSave: 'negate', duration: 'Instant' }],
  ['Elemental Manipulation', 1, 'Novice', 'Shape a small amount of air, earth, fire, or water', { duration: '5' }],
  ['Farsight', 2, 'Seasoned', 'See distant places as though present', { duration: '5' }],
  ['Growth/Shrink', 2, 'Seasoned', 'Change a target’s Size, Strength, and Toughness', { duration: '5' }],
  ['Havoc', 2, 'Novice', 'Fling everyone in a blast area 2d6″ and knock them Prone', { rangeFt: 144, save: 'strength', onSave: 'negate', aoe: { shape: 'sphere', sizeHexes: 3 }, condition: 'prone', duration: 'Instant' }],
  ['Intangibility', 5, 'Heroic', 'Become insubstantial and pass through matter', { duration: '5' }],
  ['Mind Link', 1, 'Novice', 'Silent communication with willing allies', { duration: '30m' }],
  ['Mind Reading', 2, 'Novice', 'Pull one honest answer from a subject’s thoughts', { rangeFt: 72, save: 'smarts', onSave: 'negate', duration: 'Instant' }],
  ['Mind Wipe', 3, 'Veteran', 'Erase or alter a subject’s recent memories', { rangeFt: 72, save: 'smarts', onSave: 'negate', duration: 'Instant' }],
  ['Object Reading', 2, 'Seasoned', 'See the past events attached to an object', { duration: 'Special' }],
  ['Sanctuary', 2, 'Novice', 'Evil creatures must resist or cannot approach', { rangeFt: 5, save: 'spirit', onSave: 'negate', duration: '5' }],
  ['Shape Change', 3, 'Novice', 'Take the form of a beast you know', { duration: '5' }],
  ['Silence', 2, 'Novice', 'Muffles all sound in a Medium Blast Template — no speech, no shouted warnings, no spoken incantations', { rangeFt: 72, condition: 'silenced', aoe: { shape: 'sphere', sizeHexes: 3 }, duration: '5' }],
  ['Slow', 2, 'Seasoned', 'Halve a target’s Pace and actions', { rangeFt: 72, save: 'agility', onSave: 'negate', condition: 'distracted', duration: '5' }],
  ['Slumber', 2, 'Seasoned', 'Everyone in a Medium Blast Template falls asleep unless they resist', { rangeFt: 72, save: 'spirit', onSave: 'negate', condition: 'unconscious', duration: '1H' }],
  ['Sound/Silence', 1, 'Novice', 'Create or suppress noise at a distance', { duration: '5' }],
  ['Speak Language', 1, 'Novice', 'Understand and be understood in any tongue', { duration: '10m' }],
  ['Summon Ally', 2, 'Novice', 'Call a servitor creature to fight for you', { duration: '5' }],
  ['Wall Walker', 2, 'Novice', 'Walk on walls and ceilings at full Pace', { duration: '5' }],
  ['Warrior’s Gift', 4, 'Seasoned', 'Grant a target a combat Edge for the scene', { duration: '5' }],
  ['Zombie', 3, 'Veteran', 'Raise a corpse as an obedient servant', { duration: '1H' }],
  ['Resurrection', 30, 'Heroic', 'Bring the dead back to life — the body must be reasonably intact and dead no more than a year; the caster rolls at −8 and the subject returns Exhausted (merely Exhausted on a raise). +5 Power Points raises someone dead up to a decade', { rangeFt: 5, duration: 'Instant' }],
  ['Sloth/Speed', 2, 'Seasoned', 'Halve a target’s movement (Sloth) or double it (Speed) — see the Slow and Speed entries, which are its two halves', { rangeFt: 72, save: 'spirit', onSave: 'negate', duration: '5' }],
];
...
export const CONTENT_SWADE: ContentEntry[] = [
  ...
  ...POWERS.map(([name, cost, rank, subtitle, mech], i): ContentEntry => ({
    ...
    subtitle: `${cost} PP · ${rank} · ${durationLabel(mech?.duration) || '—'} · ${subtitle}`,
    power: {
      discipline: rank, level: cost, notes: subtitle,
      ...(mech?.duration ? { duration: mech.duration } : {}),
