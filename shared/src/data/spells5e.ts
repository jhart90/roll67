...
const SPELLS: S[] = [
  ...
  ['Chill Touch', 0, 'Necromancy', '1 action', '120 ft', 'V,S', '1 round', false, '1d8', 'attack', 'necrotic'],
  ['Dancing Lights', 0, 'Evocation', '1 action', '120 ft', 'V,S,M', '1 min', true],
  ['Druidcraft', 0, 'Transmutation', '1 action', '30 ft', 'V,S', 'Instant', false],
  ['Eldritch Blast', 0, 'Evocation', '1 action', '120 ft', 'V,S', 'Instant', false, '1d10', 'attack', 'force'],
  ['Fire Bolt', 0, 'Evocation', '1 action', '120 ft', 'V,S', 'Instant', false, '1d10', 'attack', 'fire'],
  ...
  ['Produce Flame', 0, 'Conjuration', '1 action', 'Self', 'V,S', '10 min', false, '1d8', 'attack', 'fire'],
  ['Ray of Frost', 0, 'Evocation', '1 action', '60 ft', 'V,S', 'Instant', false, '1d8', 'attack', 'cold'],
  ['Sacred Flame', 0, 'Evocation', '1 action', '60 ft', 'V,S', 'Instant', false, '1d8', 'DEX negates', 'radiant'],
  ['Shocking Grasp', 0, 'Evocation', '1 action', 'Touch', 'V,S', 'Instant', false, '1d8', 'attack', 'lightning'],
  ...
  ['Guiding Bolt', 1, 'Evocation', '1 action', '120 ft', 'V,S', '1 round', false, '4d6', 'attack', 'radiant'],
