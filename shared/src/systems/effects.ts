...
export const CONDITIONS: ConditionDef[] = [
  ...
  { id: 'paralyzed', label: 'Paralyzed', icon: '🧊', systems: ['dnd5e', 'swade'], grantsAttackAdv: true, incapacitated: true, desc: "Incapacitated, can't move/speak; melee hits crit; auto-fails STR/DEX saves.", swadeDesc: 'Rigid and incapable of any action, even speech, for 2d6 rounds unless the creature’s description says otherwise. Attackers have The Drop. The duration is the DM’s to clear — the basilisk and the ghoul are the reason this is a SWADE condition at all.' },
